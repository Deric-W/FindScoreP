...
\begin{document}
    ...
    \begin{center}
        \begin{tikzpicture}
            \begin{axis}[
                title=Zeit zum Konfigurieren des Beispielprojekts,
    ...
    Es ist ersichtlich dass die Laufzeit schneller als linear wächst während gleichzeitig das Verzichten
    auf die `AUTO' Option nur eine geringe Geschwindigkeitsverbesserung ergibt.
